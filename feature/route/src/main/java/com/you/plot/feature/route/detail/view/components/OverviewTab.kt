    ...
    LazyColumn(
        ...
        item {
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                RouteDetailStatCard("↑ Gain", "%.0f m".format(elevGainM), Modifier.weight(1f))
                RouteDetailStatCard("↓ Loss", "%.0f m".format(elevLossM), Modifier.weight(1f))
            }
        }
            ...
            Card(
                ...
                Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                    RouteMetaRow(
                        ...
                        createdAt = createdAt,
                        editable = editable,
                        onSportTypeChip = onSportTypeChip,
