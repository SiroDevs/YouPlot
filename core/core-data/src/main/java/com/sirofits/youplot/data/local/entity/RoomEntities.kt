package com.sirofits.youplot.data.local.entity
...
data class RouteEntity(
    ...
    val endLat: Double,
    val endLng: Double,
    val waypointsJson: String,           // JSON-serialised List<Waypoint>
    val elevationProfileJson: String,    // JSON-serialised List<ElevationPoint>
...
data class SessionEntity(
    ...
    val distanceCoveredKm: Double,
    val waypointProgressJson: String,    // JSON-serialised List<WaypointProgress>
